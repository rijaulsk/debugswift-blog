 ...
 *
 * lucide-react removed social brand icons (trademark reasons), so the four
 * socials + WhatsApp are hand-inlined from their official single-path marks.
 * 24×24 viewBox, fill:currentColor — colour comes from the parent's text class,
  ...
  return (
    <span
      ...
      style={{
        width,
        height,
        /* currentColor (the keyword, not the theme var) so the mark takes the
