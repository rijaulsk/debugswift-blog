 ...
 * each link decides how to render: anything under /blog is this app and uses
    ...
    <nav aria-label="Breadcrumb" className="text-small text-stone">
      <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
        {trail.map((crumb, i) => {
          ...
          const inBlog = crumb.url.startsWith(blogRoot);
          /* next/link wants the path WITHOUT basePath; it re-adds it. */
          const blogPath = crumb.url.slice(blogRoot.length) || "/";
          const linkClass =
