 ...
 * (/contact#diagnosis is the closing CTA of every post), and this app runs
 * under basePath "/blog" — so next/link would render /blog/contact. `main`
 * therefore defaults to TRUE and produces a bare <a>.
 *
 * Pass main={false} for a destination inside the blog, which is the only case
 * where next/link is right. See components/MainSiteLink.tsx for the full rule. */
